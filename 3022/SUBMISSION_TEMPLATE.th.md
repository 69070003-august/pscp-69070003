...
```text
inputรับเข้ามาเป็นตัวเลขและตัวอักษร2ตัว แล้วใช้if elifตั่งเงื่อนไขและใช้สูตรที่โจทย์ให้มาจากนั้นก็printแสดงผลออกมาตามที่โจทย์กำหนดพร้อมใช้:.2f
```
...
```text
Step 1:inputรับเข้ามาเป็นตัวเลขและตัวอักษร2ตัว
Step 2:ใช้if elifตั่งเงื่อนไขและใช้สูตรที่โจทย์ให้มา
Step 3:printแสดงผลออกมาตามที่โจทย์กำหนดพร้อมใช้:.2f
```
...
```text
เหมือนที่วางแผนไว้ จริงๆผมเจอวิธีที่ไวกว่าแต่ทำจะเสร็จอยู่แล้วจึงใช้แผนนี้ต่อ
```
...
```text
บางคนลืมว่าอาจต้องใช้ตัวอักษรเดียวกัน
```
