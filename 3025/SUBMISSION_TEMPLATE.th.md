...
```text
ผมรับข้อมูลinputเป็นวันและเดือนแล้วแปลงให้เป็นวันทั้งหมดแล้วตั่งเงื่อนไขเป็นจำนวนวัน
```
...
```text
Step 1:รับข้อมูลวันและเดือน
Step 2:แปลงเป็นวันอย่างเดียวแล้วตั่งเงื่อนไขจากจำนวนวัน
Step 3:แสดงผลตามเงื่อนไขที่ตั่งไว้
```
...
```text
เหมือนกัน เพราะแผนทำงานวางไว้ดี
```
