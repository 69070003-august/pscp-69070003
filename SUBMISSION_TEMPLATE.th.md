...
```text
รับค่าสี2สีแล้วตั่งเงื่อนไขในการผสมสีแต่ละสีขึ้นมาแล้วแสดงผลตามเงื่อนไง
```
...
```text
Step 1:รับค่าสีทั้ง2
Step 2:ตั่งเงื่อนไขในการผสมแต่ละสี
...
```text
เหมือนกัน เพราะวางแผนอย่างรัดกุม
```
...
```text
คนชอบลืมเรื่องการผสมสีเดียวกัน
```
