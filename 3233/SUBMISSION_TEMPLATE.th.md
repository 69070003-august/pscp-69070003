...
```text
รับหมวดตัวอักษรและเลขสลาก 5 หลักของ เลขที่ออก และ สลากของเรา
แสดงจำนวนเงินรางวัลตามเงื่อนไขที่ตรงกัน
```
...
```text
Step 1:รับหมวดตัวอักษรและเลขสลาก 5 หลักของ เลขที่ออก และ สลากของเรา
Step 2:ตรวจเลขเรียงตามขนาดรางวัล
Step 3:แสดงจำนวนเงินรางวัลตามเงื่อนไขที่ตรงกัน
```
...
```text
ตามแผนที่วางไว้ เพราะวางแผนมาดี
```
