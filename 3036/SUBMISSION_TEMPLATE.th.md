...
```text
inputคือจำนวนชั้นเราจะต้องหาชั้นและหาว่าห้องนั้นอยู่ด้านบนหรือด้านล่างขแงชั้น
```
...
```text
Step 1:รับห้องที่ต้องการรู้
Step 2:ตั่งเงื่อนไขสำหรับห้อง1และตรวจชั้นจากเลขยกกำลัง
Step 3:printจำนวนชั้นโดย1ชั้นทำลาย2กำแพงแต่ห้องบนของชั้นจะทำลายกำแพงเดียว
```
...
```text
เหมือนที่วางแผนได้เพราะวางแผนมาดี
```
