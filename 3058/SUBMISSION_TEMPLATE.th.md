...
```text
เราต้องใช้อิทก้อนใหญาให้หมดก่อนจึงเรื่มนับก้อนเล็ก
```
...
```text
Step 1:ใช้อิทใหญ่ให้เยอะที่สุดเท่าที่จะทำได้แล้วค่อนเริ่มนับจำนวนอิทก้อนเล็ก
Step 2:ดูว่าก้อนเล็กมีมากพอที่จะต่อไหม
Step 3:ถ้าพอก็ตอบช่องว่างที่เหลือถ้าไม่แสดง-1
```
