...
```text
ต้องรับinputเป็นตัวอักษรแล้วเปลี่ยนเป็นตัวเล็กทั้งหมดจากนั้นก็ใช้for i in range ไล่ print จากหลังสุดมาหน้าสุดและใช้end=""ต่อท้าย
```
...
```text
Step 1:รับข้อมูล
Step 2:เปลี่ยนให้เป็นlower
Step 3:printจากหลังมาหน้า
```
...
```text
เหมือนแผนที่วางไว้ เพราะวางแผนได้ดี
```
