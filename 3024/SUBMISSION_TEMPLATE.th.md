...
```text
รับค่าตัวเลขรวมและเลขมากสุดแล้วตั่งเงื่อนไงถ้ามากสุดน้อยกว่าเท่ากับ2แสดงว่าไม่แน่นอนแล้วตั่งเงื่อไขถ้ามากสุดลบน้อยสุดแล้วมากกว่า2ก็ให้เป็น
```
...
```text
Step 1:รับinput2เลข
Step 2:หาค่าน้อยสุดที่เป็นไปได้แล้วเอาไปลบกับเลขมากสุด
Step 3:print ผลที่ได้ออกมา
```
...
```text
เหมือนที่วางแผนไว้เพราะวางแผนมาอย่างรอบคอบ
```
...
```text
บางคนลืมเงื่อไขถ้ามากสุด==2อยู่แล้วยังไงคำตอบก็จะเป็นไม่
```
