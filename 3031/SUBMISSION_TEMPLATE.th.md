...
```text
inputรับเป็นความเร็วและจำนวนบ้านก่อน
แล้ววนรอบรับx,yจากนั้นหาระยะห่างด้วยสูตรa = pi(x**2 +y**2)
outputใช้ceilปัดเลข
```
...
```text
Step 1:inputรับเป็นความเร็วและจำนวนบ้านก่อน
Step 2:วนรอบรับx,yจากนั้นหาระยะห่างด้วยสูตรa = pi(x**2 +y**2)
Step 3:outputใช้ceilปัดเลข
```
...
```text
เหมือนที่วางแผนไว้ เพราะ วางแผนดี
```
