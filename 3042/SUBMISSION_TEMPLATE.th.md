...
```text
รับinputมาเป็นตัวเลข
printออกมาด้วยค่าiและใช้,end=" "
```
...
```text
Step 1:รับinput
Step 2:ใช้for i in rangeค่อยๆไล่ค่าลงมาแล้วใช้ifตั่งเงื่อนไขอีกที
Step 3:printค่าiที่ตรงกับเงื่อนไข
```
...
```text
ใช้วิธีเดียวกับแผยแรกเพราะวางแผนไว้ดี
```
...
```text
บางคนใช้%ไม่เป็นเลยใช้การดูเลข0ตัวที่2แทน
```
